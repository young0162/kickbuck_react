...
class QnaBoardDetail extends Component {
  ...
  onDataDelete = num => {
    ...
    var url =
      "http://localhost:9000/controller/qnaboard/delete?num=" +
      this.state.selectData.num;
      ...
      <div>
        ...
        <table className="board qnaboard detail qnaboarddetail">
          <tbody>
            ...
            <tr>
              <td width="900px">{this.state.selectData.user_name}</td>
              <td width="100px">{this.state.selectData.readcnt}</td>
            </tr>
            <tr>
              <td colSpan="2" width="1000px">
        ...
        <button
          ...
          onClick={() => {
            this.history.push("/community/qnaboardwrite");
          }}
        >
          글 쓰 기
        </button>
        <button
          ...
          onClick={() => {
            this.history.push(
              "/community/qnaboardupdate/" + this.state.selectData.num
            );
          }}
        >
          수 정
