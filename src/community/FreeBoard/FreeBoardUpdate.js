      ...
      <div>
        ...
        <div className='board_container'>
          <table className="board">
            ...
            <tbody className='board_body'>
              <tr>
                ...
                <td>
                  <input type="text" className="input_title input_area" style={{width:'1000px', height: '50px'}}
              ...
              <tr>
                ...
                <td>
                  <textarea
                    value={this.state.content} className="input_content input_area" 
                    style={{width:'1000px', height:'400px'}} required="required"
                    onChange={this.onKeyChange}
          ...
          <form onSubmit={this.onSubmit} style={{float:'right'}}>
            <Button type="submit" className='btn_function' variant="contained" color="primary">저장</Button>
